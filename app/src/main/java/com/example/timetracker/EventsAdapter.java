...
import com.example.timetracker.timerview.TimerView;
...
public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.ViewHolder> implements EventTouchHelperListener {
    ...
    private int VIEW_TYPE_1 = 1, VIEW_TYPE_2 = 2;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(Event event) {
            ...
            if(event.getEndDate() < System.currentTimeMillis()) {
                ...
                mEventItemActionListener.onReminderComplete(event.getId());
            }
        }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_1) {
            itemView = mInflater.inflate(R.layout.item_event, parent, false);
        }else {
            itemView = mInflater.inflate(R.layout.item_event_second, parent, false);
        }
